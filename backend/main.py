...
def main(idea, designation):
    ...
    for i, (community_name, similarity_score) in enumerate(top_3_communities, 1):
        ...
        if community_name not in final_results:
            final_results[community_name] = []
        community_results[community_name] = similarity_score
        final_results[community_name].append([community_name, similarity_score, ['name1','name2','name3']])
